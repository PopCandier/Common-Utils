package com.pop.echars;

import com.google.gson.annotations.Expose;
import com.pop.uitils.ReflectUtils;
import lombok.Data;
...
public class ECharts<T>  {
    ...
    private Series[] parseSeries(List<T> data,SeriesMapper mapper){
        Map<String,String> map = mapper.mapRow(new HashMap<String,String>());
        Series[] series = new Series[map.size()];//映射了多少字段，初始化多少in
        int count =0;
